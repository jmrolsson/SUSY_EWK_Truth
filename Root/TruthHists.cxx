...
TruthHists :: TruthHists (std::string name, std::string detailStr, float truth_ptMinCut, float truth_etaAbsMaxCut) :
...
StatusCode TruthHists::initialize() {
  ...
  if (m_detailStr.find("substructure") != std::string::npos ) {
    ...
    m_good_diboson_MET_dEta      = book(m_name, "truth_diboson_MET_dEta", "#Delta#eta(di-boson, MET)", nBinsDR, minBinDR, maxBinDR );
    m_good_diboson_MET_dPhi      = book(m_name, "truth_diboson_MET_dPhi", "#Delta#phi(di-boson, MET)", nBinsDR, minBinDR, maxBinDR );
    m_good_diboson_MET_dR        = book(m_name, "truth_diboson_MET_dR", "#DeltaR(di-boson, MET)", nBinsDR, minBinDR, maxBinDR );

    m_good_W_MET_dEta            = book(m_name, "truth_W_MET_dEta", "#Delta#eta(W, MET)", nBinsDR, minBinDR, maxBinDR );
    m_good_W_MET_dPhi            = book(m_name, "truth_W_MET_dPhi", "#Delta#phi(W, MET)", nBinsDR, minBinDR, maxBinDR );
    m_good_W_MET_dR              = book(m_name, "truth_W_MET_dR", "#DeltaR(W, MET)", nBinsDR, minBinDR, maxBinDR );

    m_good_Zh_MET_dEta           = book(m_name, "truth_Zh_MET_dEta", "#Delta#eta(Z/h, MET)", nBinsDR, minBinDR, maxBinDR );
    m_good_Zh_MET_dPhi           = book(m_name, "truth_Zh_MET_dPhi", "#Delta#phi(Z/h, MET)", nBinsDR, minBinDR, maxBinDR );
    m_good_Zh_MET_dR             = book(m_name, "truth_Zh_MET_dR", "#DeltaR(Z/h, MET)", nBinsDR, minBinDR, maxBinDR );
