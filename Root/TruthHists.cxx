...
StatusCode TruthHists::initialize() {
  ...
  unsigned int nBinsPt = 250; float minBinPt = 0.0; float maxBinPt_s = 500.; float maxBinPt = 1000.; float maxBinPt_l = 2000.;
  ...
  m_truth_pt            = book(m_name, "truth_pt",            "truth p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
  m_truth_pt_m          = book(m_name, "truth_pt_m",          "truth p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
  ...
  if( m_detailStr.find("leptons") != std::string::npos ) {
    ...
    m_e_pt             = book(m_name, "truth_e_pt",             "e p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_e_pt_m           = book(m_name, "truth_e_pt_m",           "e p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_mu_pt            = book(m_name, "truth_mu_pt",            "#mu p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_mu_pt_m          = book(m_name, "truth_mu_pt_m",          "#mu p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_tau_pt           = book(m_name, "truth_tau_pt",           "#tau p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_tau_pt_m         = book(m_name, "truth_tau_pt_m",         "#tau p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_lepton_pt        = book(m_name, "truth_lepton_pt",        "lepton p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_lepton_pt_m      = book(m_name, "truth_lepton_pt_m",      "lepton p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
  ...
  if( m_detailStr.find("quarks") != std::string::npos ) {
    ...
    m_t_pt            = book(m_name, "truth_t_pt",            "t p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_t_pt_m          = book(m_name, "truth_t_pt_m",          "t p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_b_pt            = book(m_name, "truth_b_pt",            "b p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_b_pt_m          = book(m_name, "truth_b_pt_m",          "b p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_quark_pt        = book(m_name, "truth_quark_pt",        "quark p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_quark_pt_m      = book(m_name, "truth_quark_pt_m",      "quark p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
  ...
  if( m_detailStr.find("bosons") != std::string::npos ) {
    ...
    m_Z_pt            = book(m_name, "truth_Z_pt",            "Z p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_Z_pt_m          = book(m_name, "truth_Z_pt_m",          "Z p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_W_pt            = book(m_name, "truth_W_pt",            "W p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_W_pt_m          = book(m_name, "truth_W_pt_m",          "W p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_h_pt            = book(m_name, "truth_h_pt",            "h p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_h_pt_m          = book(m_name, "truth_h_pt_m",          "h p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
  ...
  if( m_fillSUSY || (m_detailStr.find("susy") != std::string::npos) ) {
    ...
    m_C1_pt            = book(m_name, "truth_C1_pt",            "C1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_C1_pt_m          = book(m_name, "truth_C1_pt_m",          "C1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_N2_pt            = book(m_name, "truth_N2_pt",            "N2 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_N2_pt_m          = book(m_name, "truth_N2_pt_m",          "N2 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_N1_pt            = book(m_name, "truth_N1_pt",            "N1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_N1_pt_m          = book(m_name, "truth_N1_pt_m",          "N1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
  ...
  if( m_detailStr.find("substructure") != std::string::npos ) {
    ...
    m_good_C1_pt    = book(m_name, "truth_good_C1_pt",   "C1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_good_C1_pt_m  = book(m_name, "truth_good_C1_pt_m", "C1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_good_N2_pt    = book(m_name, "truth_good_N2_pt",   "N2 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_good_N2_pt_m  = book(m_name, "truth_good_N2_pt_m", "N2 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_good_N1_from_C1_pt    = book(m_name, "truth_good_N1_from_C1_pt",   "N1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_good_N1_from_C1_pt_m  = book(m_name, "truth_good_N1_from_C1_pt_m", "N1 p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_good_W_from_C1_pt     = book(m_name, "truth_good_W_from_C1_pt",    "W p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_good_W_from_C1_pt_m   = book(m_name, "truth_good_W_from_C1_pt_m",  "W p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_good_Zh_from_N2_pt    = book(m_name, "truth_good_Zh_from_N2_pt",   "Z/h p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_s );
    m_good_Zh_from_N2_pt_m  = book(m_name, "truth_good_Zh_from_N2_pt_m", "Z/h p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt );
    ...
    m_good_W_decays_pt   = book(m_name, "truth_good_W_decays_pt",   "b/#bar{b} p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_l);
    m_good_W_decays_pt1     = book(m_name, "truth_good_W_decays_pt1",   "Leading b/#bar{b} p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_l);
    m_good_W_decays_pt2     = book(m_name, "truth_good_W_decays_pt2",   "Subleading b/#bar{b} p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_l);
    m_good_W_decays_dR      = book(m_name, "truth_good_W_decays_dR",      "#DeltaR q#bar{q}", nBinsDR, minBinDR, maxBinDR );
    m_good_Zh_decays_pt   = book(m_name, "truth_good_Zh_decays_pt",   "q/#bar{q} p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_l);
    m_good_Zh_decays_pt1     = book(m_name, "truth_good_Zh_decays_pt1",   "Leading q/#bar{q} p_{T} [GeV]", nBinsPt, minBinPt, maxBinPt_l);
...
StatusCode TruthHists::execute( const xAOD::TruthParticleContainer* truths, float eventWeight ) {
  ...
  if( m_fillSubstructure ) {
    ...
    if( m_C1.size() > 0 && m_N2.size() > 0 ) {
      ...
      m_good_C1_pt_m -> Fill(m_C1[0]->pt()/1e3, eventWeight );
      ...
      m_good_N2_pt_m -> Fill(m_N2[0]->pt()/1e3, eventWeight );
    ...
    if( m_N1_from_C1.size() > 0 && m_W_from_C1.size() > 0 ) {
      ...
      m_good_N1_from_C1_pt_m -> Fill( m_N1_from_C1[0]->pt()/1e3);
      ...
      m_good_W_from_C1_pt_m -> Fill( m_W_from_C1[0]->pt()/1e3);
    ...
    if( m_N1_from_N2.size() > 0 && m_Zh_from_N2.size() > 0 ) {
      ...
      m_good_N1_from_N2_pt_m -> Fill( m_N1_from_N2[0]->pt()/1e3);
      ...
      m_good_Zh_from_N2_pt_m -> Fill( m_Zh_from_N2[0]->pt()/1e3);
