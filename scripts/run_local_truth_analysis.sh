...
do
  echo xAH_run.py --files SUSY_EWK_Truth/filelists/mc15_13TeV_C1N2_${sample}_bbqq_J10.txt --inputList --config SUSY_EWK_Truth/scripts/truth_analysis_config.py --submitDir results/C1N2_${sample}_bbqq_J10 --verbose --force direct
done;
